module dutch_auction_address::dutch_auction {
    ...
    #[resource_group_member(group = aptos_framework::object::ObjectGroup)] //@Not Understand
    ...
    fun init_module(creator: &signer) {
        ...
        //create_unlimited_collection --> Creates a collection with no supply limit.
    ...
    entry public fun start_auction(
        ...
        //@create_named_token --> Not Understand Why it will be used 
        ...
        let transfer_ref = object::generate_transfer_ref(&sell_token_ctor);//Not Understand

        let sell_token = object::object_from_constructor_ref<Token>(&sell_token_ctor);//Not Understand
